...
// instructor
func GetDataStudent(c *fiber.Ctx) error {
	...
	database.DB.Table("users").Where("type = 'student'").Count(&totalRecords)

	// Apply search filter if provided
	query := database.DB.Table("users").Where("type = 'student'")
...
// create account
func CreateStudentAccountController(c *fiber.Ctx) error {
...
// post
func CreateStudentAccountPostController(c *fiber.Ctx) error {
	...
	return c.Redirect("/admin/account-student")
	// ...
}

// update account
func UpdateStudentAccountController(c *fiber.Ctx) error {
	var p models.User
...
// put
func UpdateStudentAccountPutController(c *fiber.Ctx) error {
	id := c.Params("id")
	var p models.Account
...
func DeleteStudentAccountController(c *fiber.Ctx) error {
	var p models.User
